...
A `Makefile`is provided at the root zith the usually rules:
...
## Usage
### Connecting with a ream IRC client (irssi)
...
│   └── parser_msg_irc.hpp  # IRC message parsing
└── srcs/
    ...
    ├── parser_msg_irc.cpp  # Splits an IRC line (prefix, command, params)
...
raw
Readme · MD
*This project has been created as part of the 42 curriculum by edidier and mamakaro.*
